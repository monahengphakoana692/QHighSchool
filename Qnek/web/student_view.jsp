...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="#" class="active"><i class="fas fa-th-large"></i> Main Dashboard</a></li>
    ...
    <div class="main-content">
        <%-- Added the back button container here --%>
        ...
        <div class="card">
            ...
            <form action="#" method="post">
                ...
                <%-- Assuming guardianFirstName and guardianLastName are part of guardianName,
                    or if you want to explicitly pass them, ensure they are sent from the previous page.
                    For now, I'll default them if not found, but it's better to pass them explicitly if separate.
                --%>
                <div class="form-group">
                ...
                <div class="button-group">
                    <button type="submit" class="btn-gradebook">View Gradebook</button>
                    <button type="submit" class="btn-update">Update</button>
                    <button type="submit" class="btn-transactions">Transactions</button>
